[python-unittest](https://code.visualstudio.com/docs/python/unit-testing)
[docs](https://github.com/Microsoft/vscode-docs/blob/master/docs/python/unit-testing.md)
---
Order: 7
Area: python
